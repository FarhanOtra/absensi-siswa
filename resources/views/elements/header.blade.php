                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link  ai-icon" href="#" role="button" data-toggle="modal" data-target="#basicModal">
							...
							<li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link  ai-icon" href="#" role="button" data-toggle="dropdown">
									...
									<span class="badge light text-white bg-primary">{{auth('sanctum')->user()->unreadNotifications()->count()}}</span>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3">
										<ul class="timeline">
											@if(auth('sanctum')->user()->unreadNotifications()->count() != 0)
												...
												<a href="{{route('show.notification',[$notification->id])}}">
													<div class="timeline-panel">
														...
														@if(isset($notification->data['image']))
															<img alt="image" width="50" src="{{ asset('storage/'. $notification->data['image']) }}">
														@else
															<img alt="image" width="50" src="{{ asset('storage/avatar.png') }}">
														@endif
														</div>
															...
															<small class="d-block">
																@if(isset($notification->data['type']))
																	@if($notification->data['type'] == 2)
																		<span class="badge badge-sm badge-warning">Sakit</span>
																	@endif
																	@if($notification->data['type'] == 3)
																		<span class="badge badge-sm badge-info">Izin</span>
																	@endif
																	{{Carbon\Carbon::parse($notification->data['date'])->translatedFormat('l, d F Y')}}
																@endif
															</small>
														</div>
													</div>
											...
											@else
												<li>
													<h6 class="text-center">Tidak Ada Permohonan</h6>
												</li>
											@endif
										</ul>
									</div>
            ...
            <div class="modal-dialog" role="document">
            	<div class="modal-content">
            		<div class="modal-header">
                        <h5 class="modal-title">Kirim Informasi Pemberitahuan</h5>
                            <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                            </button>
                    </div>
			<form action="{{route('send.notification')}}" method="post" id="add_form" enctype="multipart/form-data">
			@csrf
            @method('POST')
